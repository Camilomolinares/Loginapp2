...
class PAdmin(tk.Tk):
    def __init__(self, name="", username="", email=""):
        ...
        self.usrimg = utl.leer_imagen(r"C:\Users\Biblioteca\Downloads\LoginAppPart2\imagenes\userinfo.png", (128, 128))
        self.imgfacebook = utl.leer_imagen(r"C:\Users\Biblioteca\Downloads\LoginAppPart2\imagenes\face.png", (32, 32))
        self.imglinkedin = utl.leer_imagen(r"C:\Users\Biblioteca\Downloads\LoginAppPart2\imagenes\linkedin.png", (32, 32))
        self.imgwebsite = utl.leer_imagen(r"C:\Users\Biblioteca\Downloads\LoginAppPart2\imagenes\website.png", (32, 32))
        self.imglogout = utl.leer_imagen(r"C:\Users\Biblioteca\Downloads\LoginAppPart2\imagenes\logout.png", (32, 32))
        ...
        #Frame_Dynamic
        self.frame_dynamic = tk.Frame(self.frame_data, bd=0, relief=tk.SOLID, width=f"{self.ancho_pantalla-200}")
